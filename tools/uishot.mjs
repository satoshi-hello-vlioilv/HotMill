...
await page.evaluate(() => {
  ...
  document.querySelectorAll('details.sec')[2].open = true;          // 素材（スラブ）
...
await page.evaluate(() => {
  for (const d of document.querySelectorAll('details.sec')) d.open = false;
  document.querySelectorAll('details.sec')[0].open = true; document.querySelectorAll('details.sec')[1].open = true;
