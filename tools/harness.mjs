...
export async function openApp(opts = {}) {
  ...
  await page.route('**/index.html', r => {
    ...
    h = h.replace(/\bnew App\(\);/, 'window.__CFG = CONFIG; window.__VER = VERSION; window.__WRAP = Wrapper; window.__ROLL = Rolling; window.__DRIVE = Drive; window.__SCRAP = Scrap; window.__CRADLE = Cradle; window.__CHAIN = CableChain; window.__LAYOUT = Layout; window.__SOAK = Soak; window.__SECT = Sect; window.__Store = Store; window.__Xlsx = Xlsx; window.__RollingLog = RollingLog; window.__app = new App();');
