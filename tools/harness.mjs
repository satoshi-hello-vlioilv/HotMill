...
export async function openApp(opts = {}) {
  ...
  await page.route('**/index.html', r => {
    ...
    h = h.replace(/\bnew App\(\);/, 'window.__CFG = CONFIG; window.__VER = VERSION; window.__ROLL = Rolling; window.__SCRAP = Scrap; window.__CRADLE = Cradle; window.__LAYOUT = Layout; window.__app = new App();');
